  ...
  const projects = [
    {
      ...
      description:
        "Developed a Machine Learning-based customer segmentation system using K-Means Clustering to identify customer groups based on income and spending behavior.",
      features: [
        "K-Means Clustering",
      ...
      github:
        "https://github.com/dadisrinivas0513/Customer-Segmentation-Analysis",
      demo: "#",
    },

    {
      ...
      description:
        "Designed and developed a fully responsive personal portfolio website using React, Vite, Tailwind CSS and Vercel.",
      features: [
        "Responsive Design",
        "Modern UI/UX",
        "GitHub Integration",
...

    {
      ...
      description:
        "Built predictive models to forecast future sales and revenue trends using historical business data.",
      features: [
        "Sales Forecasting",
        "Revenue Prediction",
        "Data Preprocessing",
    ...
    <section id="projects" className="px-6 py-20">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8">
        {projects.map((project, index) => (
          <div
            key={index}
            className="bg-white/10 backdrop-blur-xl border border-cyan-400/20 rounded-3xl overflow-hidden hover:border-cyan-400 hover:scale-105 hover:-translate-y-2 transition-all transition duration-500"
          >
            <img
              src={project.image}
              alt={project.title}
